...
from modules.rollout_sb3 import rollout  # your UPDATED rollout
...
# Load SB3 model
sb3_model = SB3TRPO.load(local_path, device="cpu")
...
for TRUE_OMEGA in tqdm(TRUE_OMEGAS_LIST):
    info = rollout(
        ...
        action_low=0.1,  # set to your training bounds
        action_high=3000.0,
    )
...
episode_summary = {
    ...
    "final_posterior_variance": float(var_list[-1].item()),
